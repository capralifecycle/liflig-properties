...
class PropertiesTest {
  ...
  inner class ForString {
    ...
    fun `stringNotNull throws when the property does not exist`() {
      val exception = assertThrows<IllegalArgumentException> { Properties().stringNotNull("foo") }
    ...
    fun `stringNotEmpty throws when the property does not exist`() {
      val exception = assertThrows<IllegalArgumentException> { Properties().stringNotEmpty("foo") }
      assertEquals("Property 'foo' is either not found or value is empty", exception.message)
    }
  }
  ...
  inner class ForInt {
    ...
    fun `int throws on invalid value`(input: String) {
      val exception =
          assertThrows<IllegalArgumentException> { mapOf("foo" to input).toProperties().int("foo") }
    ...
    fun `intRequired throws when the property does not exist`() {
      val exception = assertThrows<IllegalArgumentException> { Properties().intRequired("foo") }
      assertEquals("Property 'foo' is either not found or value is empty", exception.message)
    }
  }
  ...
  inner class ForLong {
    ...
    fun `longRequired throws when the property does not exist`() {
      val exception = assertThrows<IllegalArgumentException> { Properties().longRequired("foo") }
      assertEquals("Property 'foo' is either not found or value is empty", exception.message)
    }
  }
  ...
  inner class ForBoolean {
    ...
    fun `booleanRequired throws when the property does not exist`() {
      val exception = assertThrows<IllegalArgumentException> { Properties().booleanRequired("foo") }
      assertEquals("Property 'foo' is either not found or value is empty", exception.message)
    }
  }
}
